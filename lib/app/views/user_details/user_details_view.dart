            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  // Profile Managed By Badge
                  if (controller.profileDetails.value.matName != null &&
                      controller.profileDetails.value.matName!.isNotEmpty) ...[
                    const SizedBox(height: 8),
                    _buildManagedByBadge(controller.profileDetails.value.matName!),
                  ] else if (controller.profileDetails.value.profileCreatedBy != null &&
                      controller.profileDetails.value.profileCreatedBy! > 0) ...[
                    const SizedBox(height: 8),
                    _buildAdminManagedBadge(),
                  ],
...
// Fallback when thumbnail loading fails
  ...
  Widget _buildAdminManagedBadge() {
    return Center(
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 4),
        decoration: BoxDecoration(
